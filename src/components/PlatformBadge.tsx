...
const platformConfig: Record<Platform, { label: string; bgClass: string; textClass: string; cardBg: string; borderClass: string; leftBorder: string }> = {
  ...
  outlook: {
    ...
    cardBg: 'bg-sky-50/60 dark:bg-sky-950/30',
...
const PlatformIcon = ({ platform, className }: { platform: Platform; className?: string }) => {
  switch (platform) {
    ...
    case 'outlook':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="currentColor">
          <path d="M22.5 12V21.5C22.5 22.0523 22.0523 22.5 21.5 22.5H12V18H19.5V12H22.5Z" />
          <path d="M22.5 7.5V10.5H19.5V7.5H22.5Z" />
          <path d="M22.5 3.5V6.5H19.5V3.5H22.5Z" />
          <path d="M10.5 12V22.5H2.5C1.94772 22.5 1.5 22.0523 1.5 21.5V12H10.5Z" />
          <path d="M1.5 9.5V2.5C1.5 1.94772 1.94772 1.5 2.5 1.5H10.5V9.5H1.5Z" />
          <path d="M12 1.5H19.5V9.5H12V1.5Z" />
        </svg>
      );
    case 'youtube':
      return (
